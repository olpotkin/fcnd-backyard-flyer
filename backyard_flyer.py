...
class BackyardFlyer(Drone):
    ...
    def calculate_box(self):
        ...
        print("Setting Home")
        # [north(meter), east(meter), down(meter)]
    ...
    def waypoint_transition(self):
        ...
        # cmd_position(north, east, altitude, heading) -> command the drone to move to a specific (N, E, altitude)
        # defined position (in meters) with a specific heading (in radians)
